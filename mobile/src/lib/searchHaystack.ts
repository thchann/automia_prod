...
export function buildCarSearchHaystackForColumns(
  ...
  if (active.has("price") && car.price != null) parts.push(String(car.price));
...
export function allLeadColumnsSelected(s: Set<LeadSearchColumnId>) {
  return (
...
export function allCarColumnsSelected(s: Set<CarSearchColumnId>) {
  return (
